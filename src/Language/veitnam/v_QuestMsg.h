char *mgQuestName[][4] = {
	...
	//·¹º§º° ÄuÌ½ºÆ®
	{	"Giuìp ðõÞ thýõng nhân"	,	"Giuìp ðõÞ thýõng nhân(F)" ,	"LevelQuest\\Quest30.Msg" , "LevelQuest\\Quest30a.Msg" },	//14
	{	"ThýÒ thaìch hang ðôòng"	,	"ThýÒ thaìch hang ðôòng(F)" ,					"LevelQuest\\Quest55.Msg" , "LevelQuest\\Quest55a.Msg" },	//15
	{	"ThýÒ thaìch hang ðôòng"	,	"ThýÒ thaìch hang ðôòng(F)" ,					"LevelQuest\\Quest55_2.Msg" , "LevelQuest\\Quest55_2a.Msg" }, //16
	{	"NhýÞng ngýõÌi baòn cuÒa Michelle"	,	"NhýÞng ngýõÌi baòn cuÒa Michelle(F)" ,	"LevelQuest\\Quest70.Msg" , "LevelQuest\\Quest70a.Msg" },	//17
	{	"Phong âìn Fury",	"Phong âìn Fury(F)" ,				"LevelQuest\\Quest80.Msg" , "LevelQuest\\Quest80a.Msg" },	//18
	{	"Nýõìc mãìt cuÒa Kaliar","Nýõìc mãìt cuÒa Kaliar(F)" ,				"LevelQuest\\Quest85.Msg" , "LevelQuest\\Quest85a.Msg" },	//19
