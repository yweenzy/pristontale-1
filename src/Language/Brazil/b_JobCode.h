JOB_DATA_CODE	JobDataBase[] = {
	...
	{	"Mechanic Master"	,"Mestre Mec?ico"	,JOB_CODE_MECHANICMASTER,	2	,BROOD_CODE_TEMPSKRON },
	{	"Warrior"		,"Guerreiro"		,JOB_CODE_WARRIOR	,	1	,BROOD_CODE_TEMPSKRON },
	{	"Combatant"		,"Combatente"		,JOB_CODE_COMBATANT	,	4	,BROOD_CODE_TEMPSKRON },
	{	"Hunter Master"		,"Mestra da Ca?"	,JOB_CODE_HUNTERMASTER	,	3	,BROOD_CODE_TEMPSKRON },
												 
	{	"Metal Leader"		,"L?er Mec?ico"	,JOB_CODE_METALLEADER	,	2	,BROOD_CODE_TEMPSKRON },
	{	"Champion"		,"Campe?"		,JOB_CODE_CHAMPION	,	1	,BROOD_CODE_TEMPSKRON },
	{	"Lancer"		,"Lancer"		,JOB_CODE_LANCER	,	4	,BROOD_CODE_TEMPSKRON },
	{	"Dion's Disciple"	,"Disc?ula de Dion"	,JOB_CODE_DIONS_DISCIPLE,	3	,BROOD_CODE_TEMPSKRON },
	...
	{	"Sagittarion"		,"Sagit?ia"		,JOB_CODE_SAGITTARION	,	3	,BROOD_CODE_TEMPSKRON },
	...
	{	"Valkyrie"		,"Valqu?ia"		,JOB_CODE_VALKYRIE	,	5	,BROOD_CODE_MORAYION },
