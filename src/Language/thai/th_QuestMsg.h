...
char *mgHaQuestName[][4] = {
	{	"A tired warehouse keeper"	,"A tired warehouse keeper(สำเร็จ)"   , "HaQuest\\Quest_tired_1start_T.msg"     , "HaQuest\\Quest_tired_1end.msg"   },
	{	"A tired warehouse keeper"	,"A tired warehouse keeper(สำเร็จ)"   , "HaQuest\\Quest_tired_1start_M.msg"     , "HaQuest\\Quest_tired_1end.msg"   },
	
	{	"Signs of fear"	    ,"Signs of fear(สำเร็จ)"        , "HaQuest\\Quest_terrified_1start_T.msg" , "HaQuest\\Quest_terrified_1end.msg" },
	{	"Signs of fear"	    ,"Signs of fear(สำเร็จ)"        , "HaQuest\\Quest_terrified_1start_M.msg" , "HaQuest\\Quest_terrified_1end.msg" },

	{	"Candy Delivery"	        ,"Candy Delivery(สำเร็จ)"         , "HaQuest\\Quest_candy_1start_T.msg"     , "HaQuest\\Quest_candy_1end.msg"   },
	{	"Candy Delivery"	        ,"Candy Delivery(สำเร็จ)"         , "HaQuest\\Quest_candy_1start_M.msg"     , "HaQuest\\Quest_candy_1end.msg"   },

	{	"Goblin Hill"	    ,"Goblin Hill(สำเร็จ)"       , "HaQuest\\Quest_goblin_1start_T.msg"    , "HaQuest\\Quest_goblin_1end.msg"  },
	{	"Goblin Hill"	    ,"Goblin Hill(สำเร็จ)"       , "HaQuest\\Quest_goblin_1start_M.msg"    , "HaQuest\\Quest_goblin_1end.msg"  },
 
	{	"Threats of the Undead"	    ,"Threats of the Undead(สำเร็จ)"     , "HaQuest\\Quest_undead_1start_T.msg"    , "HaQuest\\Quest_undead_1end.msg"  },
	{	"Threats of the Undead"	    ,"Threats of the Undead(สำเร็จ)"     , "HaQuest\\Quest_undead_1start_M.msg"    , "HaQuest\\Quest_undead_1end.msg"  },

	{	"One-eyed Monsters"	,"One-eyed Monsters(สำเร็จ)"   , "HaQuest\\Quest_cyclops_1start.msg"     , "HaQuest\\Quest_cyclops_1end.msg" },

	{	"A lost Hammer"	    ,"A lost Hammer(สำเร็จ)"     , "HaQuest\\Quest_hammer_1start.msg"      , "HaQuest\\Quest_hammer_1end.msg"  },
	...
	{	"Fury's phantasma[5]"	,"Fury's phantasma(สำเร็จ)"        , "HaQuest\\Quest_100State_5.msg"         , "HaQuest\\Quest_100State_6.msg"  },
