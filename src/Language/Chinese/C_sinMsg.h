...
sMESSAGEBOX	sMessageBox[100] = {
	...
	{"物品冶炼失败."}, // pluto 冶炼失败信息
	{"物品制造失败."}, // pluto 制造失败信息
	{"组合宝石的状态下不能持有矿石/宝石."}, // pluto
	{"古老文字的组合状态下不能持有秘籍."}, // pluto
	{"不是同类矿石/水晶"}, // pluto
	{"制造公式或排列顺序错误"}, // pluto MESSAGE_NOT_NEED_RUNE
};
...
sMESSAGEBOX3 sMessageBox3[MESSAGE3_MAX] = {
	...
	{"您希望", "接受该任务吗?"}, //G
	{"您希望", "使用该物品吗?"},       //使用购买物品
	{"您希望 ", "接受该任务吗?"},//是否接受100LV任务
	{"您希望 ", "接受该物品吗?"},   //100LV物品
	{"您希望","移动到大练场吗?"},   //是否移动到100LV任务大练场
	{"您想", "进行传送吗?"},    					//Teleport 												//pluto
	{"您想", "交易该物品么? "}, //Change item(Shining dust) 			//pluto
	{"你想", "进行传送吗?"},    		//Twisted forest 									//pluto
	{"你想", "改造物品吗?"}, 	// Manufacturing message 					//pluto
	{"你想", "进行传送吗?"},    		// The newest map(Endless tower) 	//pluto
};
...
char *SmeltingResultTitle = "物品冶炼结果";		// pluto 冶炼
char *ManufactureResultTitle = "物品制造结果";	// pluto 制造
char *ManufacturingTitle = "随机";	//random
...
//char *sinPartyHealDoc = " 在组队的情况下回复生命力/3 :\r 相应的经验值上升:\r";
...
char *FallGameName = "精灵之林"; // Twisted forest
char *EndlessGameName = "迷失之塔"; // Endless tower
char *LookHelp	= ">>详细信息..."; //>>more..
...
char *PremiumItemDoc[][2]={
	...
	{"重置技能点\r"     ,""},    //技能初始化物品
	{"重置属性/技能点\r",""},     //属性初始化物品
	{"使死亡的玩家\r"    ,"自动复活.\r"},        //复活物品
	{"在瞬间成无敌状态.\r","但攻击力会降低1/2\r"},  //永恒生命
	{"增加15%的\r"    ,"致命一击.\r"},		//暴怒卷轴
	{"增加15%的\r"         ,"躲避机率.\r"},		//闪避卷轴
};
char *UpKeepItemDoc[] = {
	"剩余时间: %d分",
	"获得物品 %d%s增加",
	...
	"作战体力药剂",
	"作战法力药剂",
	"负重%d增加",	// pluto mite of awell
	"灵力消耗减少 %d%s",		// pluto Mana reduce potion 
	0,
};
char *UpKeepItemName[] = {
	"增加装备掉落的药水",
	...
	"生命回复药剂",
	"灵力回复药剂",
	"负重强化药水",		// pluto mite of awell
	"精英灵力药水",		// pluto Mana reduce potion
	"凤凰",			// phoenix
	0,
};