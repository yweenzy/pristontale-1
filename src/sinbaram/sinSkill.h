...
public:
	...
	DIRECTDRAWSURFACE	lpSkillGage[2];		//0은 통짜 1은 꼭따리 
	DIRECTDRAWSURFACE	lpSkillGage2[2];	//0은 통짜 1은 꼭따리 
	DIRECTDRAWSURFACE	lpSkillGage3;		//
	DIRECTDRAWSURFACE	lpSkillGage4;		//
	DIRECTDRAWSURFACE	lpSkillGage5;		//
	DIRECTDRAWSURFACE	lpSkillTitle[4];	//직업 타이틀 
	DIRECTDRAWSURFACE    lpSkillButton_Gray[17];	//버튼 비활성화 이미지 
	DIRECTDRAWSURFACE    lpSkillButton[17];	//버튼 이미지 
	DIRECTDRAWSURFACE    lpSelectSkill;		//버튼 선택 
	DIRECTDRAWSURFACE    lpShortKey[8];		//펑션키 
	DIRECTDRAWSURFACE    lpSkillBoxBack;		//스킬 이미지없을때 배경 
	DIRECTDRAWSURFACE    lpWeaponIcon[10];	//무기 아이콘 
	DIRECTDRAWSURFACE    lpMasteryInfo;		//숙련도 표시 박스 
	DIRECTDRAWSURFACE    lpSkillDown;        //스킬 다운 버튼표시
