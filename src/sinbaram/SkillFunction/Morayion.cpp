...
{ 
	...
	*/
	...
	//////////// 아틀란타 방패던지기 , 쉴드 스트라이크
	if (lpSkill->CODE == SKILL_SHIELD_STRIKE || lpSkill->CODE == SKILL_SOUL_SUCKER || lpSkill->CODE == SKILL_EXTREME_SHIELD || lpSkill->CODE == SKILL_DIVINE_INHALATION || lpSkill->CODE == SKILL_SPARK_SHIELD || lpSkill->CODE == SKILL_GODLY_SHIELD) {
		if(lpSkill->UseSkillFlag){
