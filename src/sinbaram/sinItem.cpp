...
sITEM sItem[MAX_ITEM] = {
		...
		*--------------------*/
		...
		{ sinWA1 | sin24,	"Fury Axe",	"WA124",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WA124",	INVENTORY_POS_RHAND,SIN_SOUND_AXES	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWA1 | sin25,	"Legend Axe",	"WA125",	ITEMSIZE * 2,	ITEMSIZE * 3,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WA125",	INVENTORY_POS_RHAND,SIN_SOUND_AXES	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		...
		{ sinWC1 | sin24,	"Legend Talon",	"WC124",	ITEMSIZE * 2,	ITEMSIZE * 3,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WC124",	INVENTORY_POS_RHAND,SIN_SOUND_CLAWS	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		...
		{ sinWH1 | sin25,	"Phoenix Hammer",	"WH125",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WH125",	INVENTORY_POS_RHAND,SIN_SOUND_HAMMER	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWH1 | sin26,	"Legend Hammer",	"WH126",	ITEMSIZE * 2,	ITEMSIZE * 3,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WH126",	INVENTORY_POS_RHAND,SIN_SOUND_HAMMER	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		...
		{ sinWM1 | sin25,	"Freyja Staff",	"WM125",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WM125",	INVENTORY_POS_RHAND,SIN_SOUND_STAFF	,ITEM_WEAPONCLASS_CASTING },
		{ sinWM1 | sin26,	"Freyja Wand",	"WM126",	ITEMSIZE * 2,	ITEMSIZE * 3,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WM126",	INVENTORY_POS_RHAND,SIN_SOUND_STAFF	,ITEM_WEAPONCLASS_CASTING },
		...
		{ sinWP1 | sin25,	"Phoenix Spear",	"WP125",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WP125",	INVENTORY_POS_RHAND,SIN_SOUND_POLES	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		...
		{ sinWS1 | sin26,	"Cronus Bow",	"WS126",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WS126",	INVENTORY_POS_LHAND,SIN_SOUND_SHOOTERS	,ITEM_WEAPONCLASS_SHOOTING },
		...
		{ sinWS2 | sin28,	"Legend Sword",	"WS228",	ITEMSIZE * 2,	ITEMSIZE * 3,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WS228",	INVENTORY_POS_RHAND,SIN_SOUND_SWORDS	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		...
		{ sinWT1 | sin25,	"Cronus Javelin",	"WT125",	ITEMSIZE * 1,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WT125",	INVENTORY_POS_RHAND,SIN_SOUND_THROWING	,ITEM_WEAPONCLASS_SHOOTING },

		{ sinWA1 | sin51,	"eXtreme Axe(5H)",	"WA151",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WA119",	INVENTORY_POS_RHAND,SIN_SOUND_AXES	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWA1 | sin52,	"Wyvern Axe(5H)",	"WA152",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WA121",	INVENTORY_POS_RHAND,SIN_SOUND_AXES	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWA1 | sin53,	"Zecram Axe(5H)",	"WA153",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WA122",	INVENTORY_POS_RHAND,SIN_SOUND_AXES	,ITEM_WEAPONCLASS_NOT_SHOOTING },

		{ sinWC1 | sin51,	"Chiemera Talon(5H)",	"WC151",	ITEMSIZE * 2,	ITEMSIZE * 3,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WC119",	INVENTORY_POS_RHAND,SIN_SOUND_CLAWS	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWC1 | sin52,	"Viper Talon(5H)",	"WC152",	ITEMSIZE * 2,	ITEMSIZE * 3,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WC121",	INVENTORY_POS_RHAND,SIN_SOUND_CLAWS	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWC1 | sin53,	"Injustice Talon(5H)",	"WC153",	ITEMSIZE * 2,	ITEMSIZE * 3,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WC122",	INVENTORY_POS_RHAND,SIN_SOUND_CLAWS	,ITEM_WEAPONCLASS_NOT_SHOOTING },

		{ sinWH1 | sin51,	"Justice Hammer(5H)",	"WH151",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WH120",	INVENTORY_POS_RHAND,SIN_SOUND_HAMMER	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWH1 | sin52,	"Guardian Hammer(5H)",	"WH152",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WH122",	INVENTORY_POS_RHAND,SIN_SOUND_HAMMER	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWH1 | sin53,	"Bane Hammer(5H)",	"WH153",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WH123",	INVENTORY_POS_RHAND,SIN_SOUND_HAMMER	,ITEM_WEAPONCLASS_NOT_SHOOTING },

		{ sinWM1 | sin51,	"Wyvern Wand(5H)",	"WM151",	ITEMSIZE * 2,	ITEMSIZE * 3,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WM120",	INVENTORY_POS_RHAND,SIN_SOUND_STAFF	,ITEM_WEAPONCLASS_CASTING },
		{ sinWM1 | sin52,	"Oracle Wand(5H)",	"WM152",	ITEMSIZE * 2,	ITEMSIZE * 3,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WM122",	INVENTORY_POS_RHAND,SIN_SOUND_STAFF	,ITEM_WEAPONCLASS_CASTING },
		{ sinWM1 | sin53,	"Celestial Staff(5H)",	"WM153",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WM123",	INVENTORY_POS_RHAND,SIN_SOUND_STAFF	,ITEM_WEAPONCLASS_CASTING },

		{ sinWP1 | sin51,	"eXtreme Spear(5H)",	"WP151",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WP120",	INVENTORY_POS_RHAND,SIN_SOUND_POLES	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWP1 | sin52,	"Dreadnaught Spear(5H)",	"WP152",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WP122",	INVENTORY_POS_RHAND,SIN_SOUND_POLES	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWP1 | sin53,	"Reaper Scythe(5H)",	"WP153",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WP123",	INVENTORY_POS_RHAND,SIN_SOUND_POLES	,ITEM_WEAPONCLASS_NOT_SHOOTING },

		{ sinWS1 | sin51,	"Mirage Bow(5H)",	"WS151",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WS121",	INVENTORY_POS_LHAND,SIN_SOUND_SHOOTERS	,ITEM_WEAPONCLASS_SHOOTING },
		{ sinWS1 | sin52,	"Wyvern Bow(5H)",	"WS152",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WS123",	INVENTORY_POS_LHAND,SIN_SOUND_SHOOTERS	,ITEM_WEAPONCLASS_SHOOTING },
		{ sinWS1 | sin53,	"Immortal Bow(5H)",	"WS153",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WS124",	INVENTORY_POS_LHAND,SIN_SOUND_SHOOTERS	,ITEM_WEAPONCLASS_SHOOTING },

		{ sinWS2 | sin52,	"Wyvern Sword(5H)",	"WS252",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WS222",	INVENTORY_POS_RHAND,SIN_SOUND_SWORDS	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWS2 | sin53,	"Justice Sword(5H)",	"WS253",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WS224",	INVENTORY_POS_RHAND,SIN_SOUND_SWORDS	,ITEM_WEAPONCLASS_NOT_SHOOTING },
		{ sinWS2 | sin54,	"Extreme Sword(5H)",	"WS254",	ITEMSIZE * 2,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_TWO,	"WS225",	INVENTORY_POS_RHAND,SIN_SOUND_SWORDS	,ITEM_WEAPONCLASS_NOT_SHOOTING },

		{ sinWT1 | sin51,	"Spike Javelin(5H)",	"WT151",	ITEMSIZE * 1,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WT120",	INVENTORY_POS_RHAND,SIN_SOUND_THROWING	,ITEM_WEAPONCLASS_SHOOTING },
		{ sinWT1 | sin52,	"Immortal Javelin(5H)",	"WT152",	ITEMSIZE * 1,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WT122",	INVENTORY_POS_RHAND,SIN_SOUND_THROWING	,ITEM_WEAPONCLASS_SHOOTING },
		{ sinWT1 | sin53,	"Heretic Javelin(5H)",	"WT153",	ITEMSIZE * 1,	ITEMSIZE * 4,	"Weapon",	ITEM_CLASS_WEAPON_ONE,	"WT123",	INVENTORY_POS_RHAND,SIN_SOUND_THROWING	,ITEM_WEAPONCLASS_SHOOTING },
