        ...
        <span style="font-family: Tahoma">
            <asp:Panel ID="Panel1" runat="server" BorderWidth="1px" Height="176px" Width="100%">
                ...
                &nbsp;<asp:DropDownList ID="cmbProcurapor" runat="server">
                    <asp:ListItem Selected="True" Value="ID">Search for ID</asp:ListItem>
                    <asp:ListItem Value="Char">Search for char name</asp:ListItem>
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<asp:DropDownList ID="cmbDia2" runat="server" Width="43px">
                </asp:DropDownList>
                /
                ...
                &nbsp;Details:&nbsp;<asp:DropDownList ID="cmbDetalhes" runat="server">
                    ...
                    <asp:ListItem Value="10">Used in aging</asp:ListItem>
                    <asp:ListItem Value="0">Catch from drop</asp:ListItem>
                    <asp:ListItem Value="17">For mature</asp:ListItem>
                    <asp:ListItem Value="12">Matured</asp:ListItem>
                    <asp:ListItem Value="5">Bought from NPC</asp:ListItem>
                    <asp:ListItem Value="6">Dropped item</asp:ListItem>
                    <asp:ListItem Value="24">Used force orb</asp:ListItem>
                    <asp:ListItem Value="7">Sold in NPC</asp:ListItem>
                    <asp:ListItem Value="25">Putted in force orb NPC</asp:ListItem>
                    <asp:ListItem Value="26">Complete force orb</asp:ListItem>
                    <asp:ListItem Value="9">Putted item in mix NPC</asp:ListItem>
                    <asp:ListItem Value="3">Mix complete</asp:ListItem>
                    ...
                    <asp:ListItem Value="2">Received item in a trade</asp:ListItem>
                    <asp:ListItem Value="8">Gave item in a trade</asp:ListItem>
                </asp:DropDownList><br />
                <br />
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp;
         ...
         <columns>
           <asp:BoundColumn DataField="RegistDay" HeaderText="Date and hour">
