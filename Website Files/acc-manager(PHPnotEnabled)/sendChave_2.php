...
//Assunto
$mail->Subject = utf8_decode("Account Key ".$ServerName."");
...
<table width="615" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="250" align="center" valign="top"><table width="615" border="0" align="center" cellpadding="2" cellspacing="3">
      ...
      <tr>
        <td>&nbsp;</td>
        <td><strong>Your email:</strong> '.$_POST['email'].'</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td width="87">&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><a href="'.$urlacesso.'&amp;invite='.$keyInvite.'"> <img src="'.$site.'/themes/reloadedpt/img/msg/autenticar.png" width="157" height="43" border="0" /> </a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
